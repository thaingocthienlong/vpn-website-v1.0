    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-slate-800">{isEn ? "Staff Management (EN)" : "Quản lý Cán bộ Nhân sự"}</h1>
                    <p className="text-slate-500">{isEn ? "Manage regular staff members." : "Quản lý thông tin Ban lãnh đạo và Cán bộ nhân viên (không bao gồm Hội đồng cố vấn)."}</p>
                </div>
                {!isEn && (
                    <Link href={`/admin/${locale}/staff/create`}>
                                    ...
                                    <tr key={s.id} className="hover:bg-slate-50 transition-colors">
                                        ...
                                        <td className="px-4 py-3 text-right">
                                            <div className="flex items-center justify-end gap-2">
                                                <Link href={`/admin/${locale}/staff/${s.id}`}>
                                    ...
                                    <tr>
                                        <td colSpan={7} className="px-4 py-12 text-center text-slate-500">
                                            <div className="flex flex-col items-center justify-center gap-3">
                                                ...
                                                <p>{isEn ? "No staff members yet." : "Chưa có nhân sự nào."}</p>
                                                {!isEn && (
                                                    <Link href={`/admin/${locale}/staff/create`}>
                                                        <Button className="bg-blue-600 hover:bg-blue-700 text-white">Thêm nhân sự đầu tiên</Button>
                                                    </Link>
                                                )}
                                            </div>
                                        </td>
