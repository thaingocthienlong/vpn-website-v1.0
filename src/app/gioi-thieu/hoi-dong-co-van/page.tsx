            ...
            <main className="flex-1 pt-24">
                ...
                <div className="relative py-12 md:py-20">
                    <div className="container mx-auto px-4 text-center relative z-10">
                        <span className="inline-block py-1 px-3 rounded-full bg-cyan-500/20 text-cyan-300 text-sm font-bold uppercase tracking-wider mb-4 border border-cyan-500/30">
                            Chuyên Gia
                        </span>
                ...
                <div className="container mx-auto px-4 py-12 space-y-16">
                    ...
                    {departmentGroups.map(({ department, staff }) => (
                        <section key={department.id} className="pt-8 border-t border-slate-200 first:border-t-0 first:pt-0">
                            <h2 className="text-2xl font-bold mb-8 text-slate-800 border-l-4 border-cyan-500/50 pl-4 uppercase">
                                {department.name}
                            </h2>
