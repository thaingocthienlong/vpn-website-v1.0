...
export default async function VisionMissionPage() {
    // Note: since this is outside [locale], locale might default to vi. 
    // If not, we explicitly pass it
                ...
                <section className="py-16 text-slate-800">
                    <div className="container mx-auto px-4 text-center">
                        ...
                        <div className="flex gap-4 justify-center flex-wrap">
                            <Link href="/gioi-thieu/co-cau-to-chuc">
                                <Button variant="outline" className="border-white text-slate-800 hover:bg-white">
                                    Cơ cấu tổ chức <ArrowRight className="ml-2 w-4 h-4" />
                                </Button>
                            </Link>
                            <Link href="/gioi-thieu/hoi-dong-co-van-khoa-hoc">
                                <Button variant="outline" className="border-white text-slate-800 hover:bg-white">
                                    Hội đồng cố vấn <ArrowRight className="ml-2 w-4 h-4" />
                                </Button>
                            </Link>
                        </div>
                    </div>
