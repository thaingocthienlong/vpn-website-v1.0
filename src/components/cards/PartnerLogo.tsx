    ...
    const content = (
        <div className="group relative flex min-h-[104px] w-full items-center justify-center overflow-hidden rounded-[1.2rem] border border-[rgba(173,187,201,0.58)] bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(251,253,255,0.92))] px-5 py-4 shadow-[0_18px_30px_-28px_rgba(8,20,33,0.18)] backdrop-blur-[10px] transition-all duration-300 hover:-translate-y-1 hover:border-[rgba(157,173,190,0.76)] hover:bg-[linear-gradient(180deg,rgba(255,255,255,0.985),rgba(253,254,255,0.95))] hover:shadow-[0_22px_34px_-28px_rgba(8,20,33,0.22)]">
            ...
            {logo ? (
                ...
                <span className="relative z-10 text-center text-sm font-medium leading-6 text-[var(--ink-soft)] transition-colors duration-300 group-hover:text-[var(--ink)]">
                    {name}
                </span>
            )}
        </div>
